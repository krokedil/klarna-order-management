...
jQuery(function ($) {
    ...
    const returnFee = {
        ...
        update_klarna_refund_amount: function () {
            ...
            const returnFeeAmount = unformat_number($klarnaReturnFeeAmountField.val()) + unformat_number($klarnaReturnFeeTaxAmountField.val());
            ...
            $klarnaReturnFeeTotalSpan.text(' (' + kom_admin_params.with_return_fee_text + ' ' + format_number(returnFeeAmount) + ')');
        },
        ...
        on_refund_submit: function (e) {
            ...
            const diff = unformat_number($refundAmount.val()) - (unformat_number($klarnaReturnFeeAmountField.val()) + unformat_number($klarnaReturnFeeTaxAmountField.val()));
